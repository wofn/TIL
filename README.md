...
- 문제 설명
  - 입력
    - 체스 세트의 각 말의 현재 개수, 입력은 킹, 퀸, 룩, 비숍, 나이트, 폰 순서
  - 출력
    - 체스 세트를 완성하기 위해 필요한 각 말의 개수를 출력
    - 출력은 킹, 퀸, 룩, 비숍, 나이트, 폰 순서로 공백으로 구분
- 접근 방법
  - 체스의 완전한 세트는 킹 1개, 퀸 1개, 룩 2개, 비숍 2개, 나이트 2개, 폰 8개로 구성
  - 주어진 입력에서 각 말의 개수를 빼면, 부족한 개수
